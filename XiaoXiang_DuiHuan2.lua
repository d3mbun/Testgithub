...
function x889064_UpdateEventList( sceneId, selfId,targetId )
	...
	-- AddText(sceneId,"#G套装升级请摘除宝石，雕文！")
	AddNumText( sceneId, x889064_g_ScriptId, "物品兑换", 3, 1999999 )
	--AddNumText( sceneId, x002084_g_scriptId, "#b#gB0E2FF元宝售卖--交子购买", 5, 301 )
	-- AddNumText( sceneId, x889064_g_ScriptId, "重楼升级", 6, 2999999 )
	-- AddNumText( sceneId, x889064_g_ScriptId, "至尊重楼进阶", 6, 3999999 )
	AddNumText( sceneId, x889064_g_ScriptId, "离开……", 0, 0 )
	EndEvent(sceneId)
